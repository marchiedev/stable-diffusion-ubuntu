...
def txt2img(beta_start=0.00085, beta_end=0.012, beta_schedule="scaled_linear", model="bes-dev/stable-diffusion-v1-4-openvino", tokenizer="openai/clip-vit-large-patch14", prompt="Street-art painting of Emilia Clarke in style of Banksy, photorealism", strength=0.5, num_inference_steps=32, guidance_scale=7.5, eta=0.0, output="output.png"):
